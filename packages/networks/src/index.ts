 ...
 *
 * Four distinct service keys over one shape. Import the connector you mean —
 * `HackerNews.HackerNews`, `Reddit.Reddit`, `X.X` — never a `DiscussionSource`
 * that could be any of them. That is what keeps ADR 0001's X gate structurally
 * enforceable and stops a Reddit fake standing in for a Hacker News one.
 *
