...
- **Safari on iOS no longer requires a Mac or Xcode.** Since iOS 26, a standards-based WebExtension can be uploaded to App Store Connect as a ZIP and packaged by Apple. A paid Apple Developer account and App Review still apply.
